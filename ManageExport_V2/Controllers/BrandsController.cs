...
namespace ManageExport_V2.Controllers
{
    public class BrandsController : Controller
    {
        ...
        public BrandsController(ExportContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ShortName,FullName,Id,CreatedDate,ModifiedDate")] Brand brand)
        {
            if (id != brand.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    brand.ModifiedDate = DateTime.Now.ToUniversalTime();
