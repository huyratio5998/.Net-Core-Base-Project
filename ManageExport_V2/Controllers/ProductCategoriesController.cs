...
namespace ManageExport_V2.Controllers
{
    public class ProductCategoriesController : Controller
    {
        ...
        public ProductCategoriesController(ExportContext context)
        {
            _context = context;
        }
        ...
        {
            var exportContext = _context.ProductCategories.Include(p => p.Category).Include(p => p.Product);
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["CategoryId"] = new SelectList(_context.Categories, "Id", "Id", productCategory.CategoryId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoryId,ProductId")] ProductCategory productCategory)
        {
