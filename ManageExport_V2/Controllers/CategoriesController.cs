...
namespace ManageExport_V2.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(ExportContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,ParentId,Id,CreatedDate,ModifiedDate")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
