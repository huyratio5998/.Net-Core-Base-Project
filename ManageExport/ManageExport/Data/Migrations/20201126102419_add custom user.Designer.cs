...
namespace ManageExport.Data.Migrations
{
    ...
    [Migration("20201126102419_add custom user")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.Entity.ExportDocumentBill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Model.Entity.ExportListDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Model.Entity.ProductCategory", b =>
                {
            ...
            modelBuilder.Entity("Model.Entity.ExportListDetail", b =>
                {
                    b.HasOne("Model.Entity.ExportDocumentBill", "ExportDocumentBill")
            ...
            modelBuilder.Entity("Model.Entity.Product", b =>
                {
                    ...
                    b.HasOne("Model.Entity.Stock", "Stock")
                        .WithMany("Products")
